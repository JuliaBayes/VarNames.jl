...
*Fundamentally, this resolves the inconsistency between indexing semantics in the actual varaible `x`, and indexing semantics of the `x` inside the `VarNamedTuple`.*
